...
@Test func setup_openCodeOnly_writesOwnedPayloadWithBakedPath() throws {
    try withTempHome { home, layout, launchctl in
        ...
        #expect(askTui.contains("paintOfficialAsk") == false)
        #expect(askTui.contains("OfficialAsk") == false)
        #expect(askTui.contains("plugin.server"))
        #expect(askTui.contains("@opencode-ai/tui/context/sdk"))
        #expect(askTui.contains("@opencode-ai/tui/context/sync"))
        #expect(askTui.contains("useSDK"))
        #expect(askTui.contains("useSync"))
