...
| **RVHooks** | **Pi / Grok / OpenCode / Claude / OpenClaw** Host adapters: shell codecs, Hook mapper/voice, embedded adapter resources | evaluation, setup mutations |
...
| `RVHooks` | `RVDomain` | Complete Pi/Grok/OpenCode/Claude/OpenClaw Host adapter behavior (`ClaudeHostCodec` + rich deny; OpenClaw short deny); no setup mutations. |
